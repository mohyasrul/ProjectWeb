      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            Hotel atau kamar tidak ditemukan
          </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {user
                      ...
                      : "Masuk untuk Menyelesaikan Pemesanan"}
                  </Button>
                </form>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>Check-in:</span>
                    <span>
                      {bookingData.checkIn?.toLocaleDateString("id-ID") ||
                        "Pilih tanggal"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Check-out:</span>
                    <span>
                      {bookingData.checkOut?.toLocaleDateString("id-ID") ||
                        "Pilih tanggal"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>
                      {formatPrice(room.price)} × {calculateNights()} malam ×{" "}
                      {bookingData.rooms} kamar
                    </span>
