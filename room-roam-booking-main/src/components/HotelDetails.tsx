...
const mockReviews = [
  {
    ...
    rating: 5,
    comment:
      "Hotel yang luar biasa dengan pelayanan yang sangat baik. Kamar bersih dan nyaman.",
...
const getRoomFacilityImages = (roomType: string) => {
  const facilityImages = {
    bathroom:
      "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    bedroom:
      "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    balcony:
...
const HotelDetails = () => {
  const { id } = useParams();
  const hotel =
    mockHotels.find((h) => h.id === parseInt(id || "1")) || mockHotels[0];
                ...
                >
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <div className="flex items-center text-gray-600 mb-2">
                            ...
                            <span>
                              {room.bedCount} {room.bedSize} Bed •{" "}
                              {room.roomSize}m²
                            </span>
                          </div>
                        ...
                        <div className="text-right">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              (window.location.href = `/booking/${hotel.id}/${room.id}`)
                            }
                          >
                            Pesan Sekarang
                          </Button>
                  ...
                  <div className="mt-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">
                      Fasilitas & Furniture Kamar
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {getRoomFacilityImages(room.type).map(
                        (facility, index) => (
