    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Hotel Pilihan</h2>
          <p className="text-gray-600">Temukan pilihan akomodasi premium terbaik kami</p>
        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm text-gray-500">({hotel.reviews} ulasan)</span>
                  </div>
                </div>
