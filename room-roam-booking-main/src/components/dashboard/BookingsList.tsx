...
const BookingsList = ({ userBookings, onViewDetails, onCancelBooking, onDeleteBooking }: BookingsListProps) => {
      ...
      <CardContent>
        {userBookings.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">Mulai jelajahi hotel dan buat pemesanan pertama Anda!</p>
