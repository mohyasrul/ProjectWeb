...
const features = [
  {
    ...
    description:
      "Kami menjamin harga terbaik atau kami akan mengembalikan selisihnya",
  },
  {
    icon: Clock,
    title: "Layanan 24/7",
    description:
      "Customer service kami siap membantu Anda kapan saja, di mana saja",
  },
  {
    icon: MapPin,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Platform booking hotel terdepan dengan layanan terbaik
          </p>
        </div>
