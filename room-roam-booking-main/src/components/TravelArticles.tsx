...
const articles = [
  {
    ...
    excerpt:
      "Temukan pilihan akomodasi terbaik di Pulau Dewata untuk liburan yang tak terlupakan",
  ...
  },
  {
    ...
    excerpt:
      "Eksplorasi kuliner terbaik Jakarta dari street food hingga fine dining",
    author: "Budi Santoso",
    date: "10 Des 2024",
    image:
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Inspirasi dan panduan untuk perjalanan Anda selanjutnya
          </p>
        </div>
